...
public class UsersBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.user.getUsername();
         }
      }
      catch (Exception e)
      {
   ...
   public String delete()
   {
      ...
      try
      {
         this.entityManager.remove(this.entityManager.find(User.class, getId()));
   ...
   private Predicate[] getSearchPredicates(Root<User> root)
   {
      ...
      String userName = this.search.getUsername();
      ...
      String phoneNumber = this.search.getPhoneNumber();
      if (phoneNumber != null && !"".equals(phoneNumber))
      {
         predicatesList.add(builder.like(root.<String> get("phoneNumber"), '%' + phoneNumber + '%'));
      }
   ...
   public Converter getConverter()
   {
      ...
      return new Converter()
      {
         ...
         public Object getAsObject(FacesContext context, UIComponent component, String value)
         {
            ...
            return UsersBean.this.entityManager.find(User.class, value);
         }
